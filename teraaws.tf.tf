...
resource "aws_instance" "inst" {
  ...
  connection {
    ...
    type     = "ssh"
    user     = "ec2-user"
    private_key = file    ("C:\Users\KIIT\Desktop\aws1\mykey111.pem")
...
provisioner "remote-exec" {
    ...
    inline = [
      ...
      "sudo git clone https://github.com/gyaneshsharma/aws-terraform.git /var/www/html/"
    ]
  }
}
...
provisioner "local-exec" {
        ...
        command     = "git clone https://github.com/gyaneshsharma/image  images"
    }
provisioner "local-exec" {
